...
export default function Home() {
  return (
    <>
      {/* ═══════════════════════════════════════════════════════════
          HERO — "The First Living City"
          Dawn aerial + faint geometry. A mountain with a machine
          sleeping inside it.
          ═══════════════════════════════════════════════════════════ */}
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
          ...
          <div className="mt-12 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-center">
            <Link href="/how-it-works" className="inline-flex items-center justify-center rounded-sm bg-white px-8 py-4 text-sm font-semibold text-stone-900 hover:bg-stone-100">See How It Works</Link>
      ...
      {/* ═══════════════════════════════════════════════════════════
          SECTION 1 — "We are building the first living city."
          Severe. Declarative. Almost no imagery. Name the object.
          ═══════════════════════════════════════════════════════════ */}
      <Section className="bg-[#F5EFE6]">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-5 text-lg leading-relaxed text-stone-700">
            <p>
              Not a housing development. Not a campus. Not a resort. Not a commune.
            </p>
            <p>
              A city that <strong className="text-stone-900">gathers what its residents actually want</strong> &mdash;
              to build, to learn, to make, to experience, to become &mdash; maps
              what those things depend on, and organizes daily life into missions,
              teams, enterprises, apprenticeships, contests, and festivals that
              make them real.
            </p>
            <p className="text-xl font-semibold text-stone-900">
              That is the whole product. Everything else is substrate.
            </p>
          </div>
        </div>
      </Section>
      ...
      {/* ═══════════════════════════════════════════════════════════
          SECTION 2 — "At full temperature, the city feels alive."
          The make-or-break section. Immediate vision hit.
          Deep obsidian. Controlled vision event.
          ═══════════════════════════════════════════════════════════ */}
      <section className="bg-[#0B0F14] px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-2 text-sm italic text-stone-500">
            Category 3 &middot; full-scale vision &middot; not on day one
          </p>

          {/* Main vision image — city at temperature */}
          <div className="mt-12 aspect-[21/9] min-h-[300px] overflow-hidden rounded-sm">
            <img src="/images/selected/03-hero-central-spire.png" alt="The living city at full scale — domain constellation across the valley" className="h-full w-full object-cover" />
          </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          SECTION 3 — "This is not a dream. This is a capital machine."
          Proof. Financials. Believability.
          ═══════════════════════════════════════════════════════════ */}
      <section className="bg-[#F5EFE6] px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-8 max-w-3xl text-base leading-relaxed text-stone-600">
            The same municipal-finance logic that built The Villages &mdash; but with
            mountain land, railroad access, mines, water, and a far more ambitious product.
          </p>

          <div className="mt-8">
            <Link href="/investors" className="inline-flex items-center gap-2 text-sm font-semibold text-stone-900 hover:text-stone-600">
              See the full investor case <span aria-hidden="true">&rarr;</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      {/* ═══════════════════════════════════════════════════════════
          SECTION 4 — "What This Mountain Becomes"
          Four transformation cards. Real substrate → future capability.
          ═══════════════════════════════════════════════════════════ */}
      <section className="bg-[#0B0F14] px-6 py-24 sm:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10">
            <Link href="/land" className="inline-flex items-center gap-2 text-sm font-semibold text-white hover:text-stone-300">
      ...
      {/* ═══════════════════════════════════════════════════════════
          SECTION 5 — "Every city begins with a first age."
          Phase 1 reality. Pioneers. Real people on real ground.
          ═══════════════════════════════════════════════════════════ */}
      <Section className="bg-white">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-stone-600">
            Phase 1 is fifty residents, five founding zones, and the first honest version
            of the coordination engine. Shared meals. Daily work blocks. Weekly contests.
            Seasonal festivals. Very little automation. Very little polish. A city just
            beginning to become itself.
          </p>
          ...
          <p className="mt-8 max-w-3xl text-base leading-relaxed text-stone-600">
            The people who arrive in Phase 1 are not arriving <em>at</em> the
            vision. They are the ones who make the vision possible. If that sounds
            like the work you were meant to do, you are the person we are looking for.
          </p>
        </div>
      </Section>

      {/* ═══════════════════════════════════════════════════════════
          SECTION 6 — Three Doors
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-3">
            <div className="flex flex-col rounded-sm border border-stone-300 bg-white p-6">
              <div className="aspect-[3/2] overflow-hidden rounded-sm">
                <img src="/images/property/photo-090.jpg" alt="Property boundary — parcel map" className="h-full w-full object-cover" />
              </div>
            ...
            <div className="flex flex-col rounded-sm border border-stone-300 bg-white p-6">
              <div className="aspect-[3/2] overflow-hidden rounded-sm">
                <img src="/images/property/photo-040.jpg" alt="Mineral substrate — raw materials" className="h-full w-full object-cover" />
              </div>
            ...
            <div className="flex flex-col rounded-sm border border-stone-300 bg-white p-6">
              ...
              <p className="mt-3 flex-1 text-sm leading-relaxed text-stone-600">
                A frontier residency for engineers, researchers, designers, and
                creators building the first living city.
              </p>
              <div className="mt-4">
